...
/**
 * DepreciatedStateDialogue component displays a dialog with a list of applications
 ...
 */
function DepreciatedStateDialogue({
  open,
  onClose,
  correctStates,
}: {
 ...
 * @param applicationMetadata - The metadata of the app to be created.
 * @param userDashboard - The current state of the user dashboard.
 * @param setUserDashboard - The function to update the user dashboard state.
...
function handleAppCreation(
  ...
  const newApp = {
    ...
    id: appId,
    type: appType,
    icon: applicationMetadata?.icon || null,
  };
